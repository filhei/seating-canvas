...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1358: (x0,x1,x2,x3,x4,x5,x6,x7) => globalThis.solve(x0,x1,x2,x3,x4,x5,x6,x7),
      _1359: () => globalThis.wasmModule,
      _1360: Date.now,
      ...
      _1601: (x0,x1) => { x0.data = x1 },
      _1602: (x0,x1) => { x0.scale = x1 },
      _1603: (x0,x1) => { x0.canvasContext = x1 },
      _1604: (x0,x1) => { x0.viewport = x1 },
      _1605: (x0,x1) => { x0.cMapUrl = x1 },
      _1606: (x0,x1) => { x0.cMapPacked = x1 },
      _1607: x0 => x0.promise,
      _1608: x0 => x0.numPages,
      _1609: x0 => x0.width,
      _1610: x0 => x0.height,
      _1611: x0 => x0.promise,
      ...
      _1851: (x0,x1) => { x0.draggable = x1 },
      _1867: x0 => x0.style,
      _2224: (x0,x1) => { x0.target = x1 },
      _2226: (x0,x1) => { x0.download = x1 },
      _2251: (x0,x1) => { x0.href = x1 },
      _2796: (x0,x1) => { x0.accept = x1 },
      _2810: x0 => x0.files,
      _2836: (x0,x1) => { x0.multiple = x1 },
      _2854: (x0,x1) => { x0.type = x1 },
      _3104: (x0,x1) => { x0.src = x1 },
      _3106: (x0,x1) => { x0.type = x1 },
      _3110: (x0,x1) => { x0.async = x1 },
      _3148: x0 => x0.width,
      _3149: (x0,x1) => { x0.width = x1 },
      _3150: x0 => x0.height,
      _3151: (x0,x1) => { x0.height = x1 },
      _3572: () => globalThis.window,
      _3612: x0 => x0.document,
      _3634: x0 => x0.navigator,
      ...
      _6331: x0 => x0.body,
      _6333: x0 => x0.head,
      _6665: (x0,x1) => { x0.id = x1 },
      _6689: (x0,x1) => { x0.innerHTML = x1 },
      _6692: x0 => x0.children,
      _8193: x0 => x0.size,
      _8194: x0 => x0.type,
      _8201: x0 => x0.name,
      _8207: x0 => x0.length,
